...
export class ContactUsComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private mailingService: MailingService, private messageService: MessageService) { 
  ...
  onSubmit(): void {
    if (this.contactForm.valid) {
      ...
      this.mailingService.sendContactForm(name, email, phone, message)
        .subscribe({
          next: (response) => {
