package com.order_management_service.config;
    ...
    public RequestInterceptor requestInterceptor() {
        return requestTemplate -> {
            ...
            if (authentication != null) {
                logger.debug("Authentification trouvée : {}", authentication.getPrincipal());
                ...
                logger.warn("Aucune authentification disponible dans le SecurityContext.");
            }
        };
    }
}
